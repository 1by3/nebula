...
The dashboard and the API accept any request that reaches the port. Locally that is fine; on a public VM anyone who finds the port can resize your mesh. See the caveats in [Deploying to Hetzner](/docs/deploy/hetzner).
</Callout>
