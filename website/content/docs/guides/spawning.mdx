...
- The Nebula Dashboard edits them (the settings fields on the page, or `POST /api/settings` with `{"key":"npcs","value":"128"}`). See [Orchestrator and Nebula Dashboard](/docs/guides/orchestrator-and-dashboard).
