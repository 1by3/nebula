...
| Mesh > Open Nebula Dashboard | Opens `http://localhost:<DashboardPort>/`. |
...
<Cards>
  <Card title="Orchestrator and Nebula Dashboard" href="/docs/guides/orchestrator-and-dashboard" description="What every event and API route means." />
  ...
  <Card title="Deploying to Hetzner" href="/docs/deploy/hetzner" description="Cloud log paths and the remote Nebula Dashboard." />
</Cards>
