...
The gateway does not cache partial updates. A new client can remain behind until it receives the next keyframe, which takes at most `SyncKeyframeInterval` ticks.
