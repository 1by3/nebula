...
namespace Nebula.Spacetime.Persistence
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(PersistedEntity = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.PersistedEntity().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<PersistedEntity, PersistedEntityCols, PersistedEntityIxCols> PersistedEntity() => new("persisted_entity", new PersistedEntityCols("persisted_entity"), new PersistedEntityIxCols("persisted_entity"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.ClearPersistence args => Reducers.InvokeClearPersistence(eventContext, args),
                Reducer.DeleteEntity args => Reducers.InvokeDeleteEntity(eventContext, args),
