...
namespace Nebula.Spacetime
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(ContainerLease = new(conn));
            AddTable(GameSetting = new(conn));
            AddTable(Gateway = new(conn));
            AddTable(Orchestrator = new(conn));
            AddTable(Worker = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.ContainerLease().ToSql(),
            new QueryBuilder().From.GameSetting().ToSql(),
            new QueryBuilder().From.Gateway().ToSql(),
            new QueryBuilder().From.Orchestrator().ToSql(),
            new QueryBuilder().From.Worker().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<ContainerLease, ContainerLeaseCols, ContainerLeaseIxCols> ContainerLease() => new("container_lease", new ContainerLeaseCols("container_lease"), new ContainerLeaseIxCols("container_lease"));
        public global::SpacetimeDB.Table<GameSetting, GameSettingCols, GameSettingIxCols> GameSetting() => new("game_setting", new GameSettingCols("game_setting"), new GameSettingIxCols("game_setting"));
        public global::SpacetimeDB.Table<Gateway, GatewayCols, GatewayIxCols> Gateway() => new("gateway", new GatewayCols("gateway"), new GatewayIxCols("gateway"));
        public global::SpacetimeDB.Table<Orchestrator, OrchestratorCols, OrchestratorIxCols> Orchestrator() => new("orchestrator", new OrchestratorCols("orchestrator"), new OrchestratorIxCols("orchestrator"));
        public global::SpacetimeDB.Table<Worker, WorkerCols, WorkerIxCols> Worker() => new("worker", new WorkerCols("worker"), new WorkerIxCols("worker"));
    }
